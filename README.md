...
> 👋 **New to VERITAS?** The [**hands-on walkthrough (`TRY-IT.md`)**](TRY-IT.md) is the gentlest start — verify a real Bitcoin-anchored attestation in your browser, then run the whole chain yourself in ~15 minutes. Prefer a print-clean version to read or share? [**Download the PDF**](TRY-IT.pdf).
