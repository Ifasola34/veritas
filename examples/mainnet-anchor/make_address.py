"""Generate a fresh VERITAS oracle key and print its MAINNET funding address.

Run this first. It creates oracle.key (mode 0600) in this folder and prints a
bc1q... mainnet address that is uniquely yours. Fund that address from your own
wallet with a dollar or two of BTC, then run anchor.py. Nothing is broadcast
here; this is offline + local (only a keypair is written to disk).
"""
...
print()
print("  MAINNET FUNDING ADDRESS:  " + addr)
print()
print("Next: fund that bc1q... address from your own wallet with a dollar or")
print("two of BTC (wait for 1 confirmation), then run:")
